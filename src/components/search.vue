...
export default {
  ...
  mounted () {
    ...
    Date.now || (Date.now = function () {
      ...
      for (let e = 0, n = ["ms", "moz", "webkit", "o"], t = 0; n.length > t && !window.requestAnimationFrame; ++t) window.requestAnimationFrame = window[n[t] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[n[t] + "CancelAnimationFrame"] || window[n[t] + "CancelRequestAnimationFrame"]
    ...
    if (document.getElementsByClassName("sketch")[0]) {
      this.updateGradient = setInterval(function () {
        ...
        let sketch = document.getElementsByClassName("sketch")

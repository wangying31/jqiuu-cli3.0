...
export default {
  ...
  data() {
    let that = this,
      { imgFormat, langType, langConf, width, height } = that,
      isSupported = true,
...
.vue-image-crop-upload
  ...
  border-radius: 2px;
  border: none;
  background-color: rgba(89, 191, 255, 0.3);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
...
.vue-image-crop-upload
  ...
  background-color: rgba(89, 191, 255, 0.15);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
...
.vue-image-crop-upload
  ...
  background-color: rgba(89, 191, 255, 0.45);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
  ...
  background-color: rgba(89, 191, 255, 0.25);
}
